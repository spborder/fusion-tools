...
1. Logged-in User functionality
    - This should enable login to *FUSION* itself, with the ability to:
        - ~~update user information (name, login, email, etc.)~~ (v3.6.40)
...
2. API access to tables in `fusionDB`
    - ~~Allow for programmatic access of elements descrived in database/models.py~~ (v3.6.40)
    - ~~Deployed alongside *FUSION* instance~~ (v3.6.40)
